...
> **Статус:** устарел. Актуальный стандарт — [`ADS-1.1.md`](./ADS-1.1.md) (Avangard Design Standard 1.1).  
> Документ сохранён как исторический источник преемственности бренда.
