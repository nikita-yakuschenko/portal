...
Материалы пока лежат во внешнем облаке по публичной ссылке — ровно как было на
Tilda. Своё хранилище с проверкой доступа и учётом скачиваний остаётся
задачей: без него ссылку по-прежнему можно переслать кому угодно.
