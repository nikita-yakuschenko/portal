...
Формы на витрине партнёра пишут в одну таблицу `site_requests`: имя, телефон,
почта и сообщение, плюс имя сработавшей формы, адрес страницы и utm-метки.
Партнёр видит их в разделе «Заявки» кабинета обычной таблицей.
